...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in model.frame.default(formula = y \textasciitilde{} 1 + a * b, drop.unused.levels = TRUE): variable lengths differ (found for 'a')}}\end{kframe}
\end{knitrout}
\end{frame}
%%%%%%%%%%%
...
\begin{knitrout}\small
\definecolor{shadecolor}{rgb}{0.843, 0.867, 0.922}\color{fgcolor}
\includegraphics[width=0.9\textwidth,height=0.9\textheight]{figure/intersexbehav-1} 
