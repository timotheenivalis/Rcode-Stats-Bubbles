...
\begin{frame}{If you get bored}
  \begin{itemize}
    ...
    \item But try and keep an eye out for interesting crumbs!
  \end{itemize}
  
  \begin{center}
    \includegraphics[height=0.3\textheight]{Figures/too-easy-whats-next.jpg}
  \end{center}
\end{frame}
%%%%%%%%%%%
...
\definecolor{shadecolor}{rgb}{0.843, 0.867, 0.922}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{dat.behav} \hlkwb{<-} \hlkwd{read.csv}\hlstd{(}\hlkwc{file} \hlstd{=} \hlstr{"datbehav.csv"}\hlstd{)}
...
\definecolor{shadecolor}{rgb}{0.843, 0.867, 0.922}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{fitstudent} \hlkwb{<-} \hlkwd{t.test}\hlstd{(}\hlkwc{x} \hlstd{= dat.behav}\hlopt{$}\hlstd{activity[dat.behav}\hlopt{$}\hlstd{weather}\hlopt{==}\hlstr{"rainy"}\hlstd{],}
                     \hlkwc{y} \hlstd{= dat.behav}\hlopt{$}\hlstd{activity[dat.behav}\hlopt{$}\hlstd{weather}\hlopt{==}\hlstr{"sunny"}\hlstd{],}
